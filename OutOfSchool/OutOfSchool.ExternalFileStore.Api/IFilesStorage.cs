    ...
    where TFile : FileModel
{
    ...
    /// </returns>
    Task<TFile> GetByIdAsync(TIdentifier fileId, string? main_subfolder = null, CancellationToken cancellationToken = default);
    ...
    Task DeleteAsync(TIdentifier fileId, string? main_subfolder = null, CancellationToken cancellationToken = default);
