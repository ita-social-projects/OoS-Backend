...
namespace OutOfSchool.Tests
{
    public static class UnitTestHelper
    {
        ...
        public static void SeedData(OutOfSchoolDbContext context)
        {
            ...
            context.Applications.Add(new Application() { Id = 1, ChildId = 1, Status = ApplicationStatus.Pending, WorkshopId = 1, ParentId = 1, CreationTime = new DateTime(2021, 7, 8), Child = context.Children.Find(1L), Parent = context.Parents.Find(1L), Workshop = context.Workshops.Find(1L) });
            context.Applications.Add(new Application() { Id = 3, ChildId = 1, Status = ApplicationStatus.Pending, WorkshopId = 1, ParentId = 1, CreationTime = new DateTime(2021, 7, 7), Child = context.Children.Find(1L), Parent = context.Parents.Find(1L), Workshop = context.Workshops.Find(1L) });
