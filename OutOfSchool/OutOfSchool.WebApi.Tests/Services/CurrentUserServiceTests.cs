...
public class CurrentUserServiceTests
{
    ...
    [Test]
    public async Task ModeratorHasRights_UserIsModeratorAndExistsInRepository_ReturnsTrue()
    {
        // Arrange
        var userId = "test-user-id";
        _mockCurrentUser.Setup(x => x.UserId).Returns(userId);
    ...
    [Test]
    public async Task ModeratorHasRights_UserIsModeratorButNotInRepository_ReturnsFalseAndLogsWarning()
    {
        // Arrange
        var userId = "test-user-id";
        _mockCurrentUser.Setup(x => x.UserId).Returns(userId);
    ...
    [Test]
    public async Task TechAdminHasRights_UserIsTechAdminAndExistsInRepository_ReturnsTrue()
    {
        // Arrange
        var userId = "test-user-id";
        _mockCurrentUser.Setup(x => x.UserId).Returns(userId);
    ...
    [Test]
    public async Task TechAdminHasRights_UserIsTechAdminButNotInRepository_ReturnsFalseAndLogsWarning()
    {
        // Arrange
        var userId = "test-user-id";
        _mockCurrentUser.Setup(x => x.UserId).Returns(userId);
