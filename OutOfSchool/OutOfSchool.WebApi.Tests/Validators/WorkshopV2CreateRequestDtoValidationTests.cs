...
public class WorkshopV2CreateRequestDtoValidationTests
{
    private WorkshopV2CreateRequestDto validDto;

    [SetUp]
    public void SetUp()
    {
        validDto = WorkshopV2CreateRequestDtoGenerator.Generate();
