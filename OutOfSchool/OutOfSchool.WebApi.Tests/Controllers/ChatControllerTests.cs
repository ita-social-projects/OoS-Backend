...
//        {
//            // Arrange
//            var newMessage = ChatMessagesDtoGenerator.Generate();
//            {
//                ChatRoomId = default,
...
//            // Assert
//            roomServiceMoq.Verify(x => x.GetById(It.IsAny<Guid>()), Times.Never);
...
//                WorkshopId = 1,
//            };
//            roomServiceMoq.Setup(x => x.GetById(chatRoomId))
//                .ReturnsAsync(() => null);
...
//            // Assert
//            roomServiceMoq.Verify(x => x.GetById(chatRoomId), Times.Once);
