...
namespace OutOfSchool.Tests.Common.TestDataGenerators
{
    ...
    public static class ProvidersGenerator
    {
        private static readonly Faker<Provider> faker = new Faker<Provider>()
            ...
            .RuleFor(x => x.Institution, f => f.Random.ArrayElement((InstitutionType[])Enum.GetValues(typeof(InstitutionType))))
            .RuleFor(x => x.Type, f => f.Random.ArrayElement((OrganizationType[])Enum.GetValues(typeof(OrganizationType))))
