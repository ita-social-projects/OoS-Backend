...
namespace OutOfSchool.WebApi.Services
{
    public interface IValidationService
    {
        ...
        /// <returns>A <see cref="Task"/> representing the result of the asynchronous operation.
        /// The task result contains the Id (type of <see cref="long"/>). If Provider or Parent with specified userId was not found, the result will be zero.</returns>
        /// <exception cref="InvalidOperationException">If the logic of creating providers was compromised.</exception>
        Task<long> GetParentOrProviderIdByUserRoleAsync(string userId, Role userRole);
    }
}
