...
public static class AsyncEnumerableExtensions
{
    ...
    /// <param name="batchSize">The size of each batch. Must be greater or equal ton 0.</param>
    ...
    /// </remarks>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="batchSize"/> is less than 0.</exception>
