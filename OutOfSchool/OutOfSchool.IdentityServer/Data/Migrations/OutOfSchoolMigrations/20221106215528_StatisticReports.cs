        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			FROM
				(SELECT
					...
					CASE 
						WHEN p.Type = 0 THEN 'FOP'
						WHEN p.Type = 1 THEN 'Social'
						WHEN p.Type = 2 THEN 'TOV'
						WHEN p.Type = 3 THEN 'Private'
						WHEN p.Type = 4 THEN 'EducationalInstitution'
						WHEN p.Type = 5 THEN 'Other'
						ELSE '' 
					END AS ProviderType,
