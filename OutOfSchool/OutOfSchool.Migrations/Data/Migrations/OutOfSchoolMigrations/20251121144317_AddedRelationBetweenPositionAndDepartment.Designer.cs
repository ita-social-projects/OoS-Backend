...
namespace OutOfSchool.Migrations.Data.Migrations.OutOfSchoolMigrations
{
    ...
    [Migration("20251121144317_AddedRelationBetweenPositionAndDepartment")]
    partial class AddedRelationBetweenPositionAndDepartment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.Department", b =>
                {
                    ...
                    b.Property<string>("EducationLevelProvided")
                        .HasColumnType("json");

                    b.Property<string>("EducationProcessForm")
                        .HasColumnType("longtext");

                    b.Property<string>("EducationalDirections")
                        .HasColumnType("json");
                    ...
                    b.Property<string>("GeneralSchedule")
                        .HasColumnType("longtext");
                    ...
                    b.Property<bool>("HasConsultationUnit")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsBlocked")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsBranchUnit")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("IsLocatedInMountains")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("OrganizationSpecialization")
                        .HasColumnType("json");
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.PermissionsForRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PackedPermissions = "ZQMCAQQKCzQzMjU2SEdJRlBRW11cVJaYl5mgoaOipKWmpw==",
                            RoleName = "Provider"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.Position", b =>
                {
                    ...
                    b.Property<bool>("IsOffStaffPosition")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsPedagogicalPosition")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<Guid>("PositionClassificationType")
                        .HasColumnType("UUID");

                    b.Property<Guid>("PositionOpenedByOrganization")
                        .HasColumnType("UUID");

                    b.Property<float>("PositionRate")
                        .HasColumnType("float");
                    ...
                    b.Property<float>("TotalRatesForPosition")
                        .HasColumnType("float");
                    ...
                    b.ToTable("Positions", t =>
                        {
                            t.HasCheckConstraint("CK_Positions_SeatsAmount_NonNegative", "SeatsAmount >= 0");
                        });
                });
                    ...
                    b.OwnsMany("OutOfSchool.Services.Models.ContactInfo.Contacts", "Contacts", b1 =>
                        {
                            ...
                            b1.ToTable("Departments_Contacts");
                            ...
                            b1.OwnsOne("OutOfSchool.Services.Models.ContactInfo.ContactsAddress", "Address", b2 =>
                                {
                                    ...
                                    b2.ToTable("Departments_Contacts");
                            ...
                            b1.OwnsMany("OutOfSchool.Services.Models.ContactInfo.Email", "Emails", b2 =>
                                {
                                    ...
                                    b2.ToTable("Departments_Contacts_Emails");
                            ...
                            b1.OwnsMany("OutOfSchool.Services.Models.ContactInfo.PhoneNumber", "Phones", b2 =>
                                {
                                    ...
                                    b2.ToTable("Departments_Contacts_Phones");
                            ...
                            b1.OwnsMany("OutOfSchool.Services.Models.ContactInfo.SocialNetwork", "SocialNetworks", b2 =>
                                {
                                    ...
                                    b2.ToTable("Departments_Contacts_SocialNetworks");
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.Position", b =>
                {
                    b.HasOne("OutOfSchool.Services.Models.Department", "DepartmentNavigation")
                        .WithMany()
