...
{
    /// <inheritdoc />
    public partial class AddSubDirectionToCompetitiveEvent : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompetitiveEventsId = table.Column<Guid>(type: "UUID(16)", nullable: false),
                    SubDirectionsId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitiveEventSubDirection", x => new { x.CompetitiveEventsId, x.SubDirectionsId });
                    table.ForeignKey(
                        name: "FK_CompetitiveEventSubDirection_CompetitiveEvents_CompetitiveEv~",
                        column: x => x.CompetitiveEventsId,
