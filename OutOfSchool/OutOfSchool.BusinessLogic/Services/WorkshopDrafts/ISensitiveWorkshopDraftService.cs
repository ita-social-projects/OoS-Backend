...
public interface ISensitiveWorkshopDraftService
{
    ...
    Task<Result<WorkshopDraftResponseDto>> UpdateDraftAsModeratorAsync(Guid draftId, ModeratorWorkshopDraftEditDto dto);
    ...
    Task<Result<WorkshopDraftResponseDto>> DeleteCoverImageAsModeratorAsync(Guid draftId);
    ...
    /// <returns>A <see cref="Result{WorkshopDraftResponseDto}"/> with the updated draft or error information.</returns>
    Task<Result<WorkshopDraftResponseDto>> DeleteImageAsModeratorAsync(Guid draftId, string imageId);
    ...
    /// <returns>A <see cref="Result{WorkshopDraftResponseDto}"/> with the updated draft or error information.</returns>
    Task<Result<WorkshopDraftResponseDto>> DeleteManyImagesAsModeratorAsync(Guid draftId, IEnumerable<string> imageIds);
}