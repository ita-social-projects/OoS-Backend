...
public interface ISensitiveWorkshopDraftService
{
    ...
    Task<Result<WorkshopDraftResponseDto>> UpdateDraftAsModeratorAsync(Guid draftId, Guid moderatorId, ModeratorWorkshopDraftEditDto dto);
    ...
    Task<Result<WorkshopDraftResponseDto>> DeleteCoverImageAsModeratorAsync(Guid draftId, Guid moderatorId);
    ...
    /// <returns>A <see cref="Result{WorkshopDraftResponseDto}"/> with the updated draft or error information.</returns>
    Task<Result<WorkshopDraftResponseDto>> DeleteImageAsModeratorAsync(Guid draftId, Guid moderatorId, string imageId);
    ...
    /// <returns>A <see cref="Result{WorkshopDraftResponseDto}"/> with the updated draft or error information.</returns>
    Task<Result<WorkshopDraftResponseDto>> DeleteManyImagesAsModeratorAsync(Guid draftId, Guid moderatorId, IEnumerable<string> imageIds);
}